...
// Use public `/images/` paths (files are in `public/images/`) so SSG resolves
const heroBgJpg = '/images/bg-img2-compressed.jpg'
const heroBgAvif = '/images/bg-img2-compressed.avif'
const heroBg960Avif = '/images/bg-img2-960.avif'
const heroBg1600Avif = '/images/bg-img2-1600.avif'
const heroBg960Webp = '/images/bg-img2-960.webp'
const heroBg1600Webp = '/images/bg-img2-1600.webp'
